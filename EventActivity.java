...
public class EventActivity extends AppCompatActivity {
    ...
    private void showBottomSheetDialog() {
        ...
        btnPostData.setOnClickListener(view -> {
            ...
            if (mImageUri == null || TextUtils.isEmpty(Objects.requireNonNull(eventName).getText()) ||
                    TextUtils.isEmpty(Objects.requireNonNull(organizer).getText())||
                    TextUtils.isEmpty(Objects.requireNonNull(whatsapp).getText()) ||
                    TextUtils.isEmpty(Objects.requireNonNull(eventDetails).getText())) {
